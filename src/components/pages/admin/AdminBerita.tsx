...
export default function AdminBerita() {
  ...
  const berita = useQuery(api.berita.getBeritaListFiltered, {
    title: searchTerm,
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <Button
          onClick={() => navigate({ to: '/admin/berita/tambah' })}
          className="gap-2"
        >
            ...
            <Select value={activeAuthor} onValueChange={setActiveAuthor}>
              ...
              <SelectContent>
                ...
                {authorList.map((author) => (
                  <SelectItem key={author._id} value={author.nama}>
                    {author.nama}
                  </SelectItem>
                ))}
              </SelectContent>
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Tindakan ini tidak dapat dibatalkan. Berita "{deleteItem?.title}"
