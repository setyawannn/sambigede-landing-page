    ...
    <div className="space-y-6 max-w-4xl mx-auto pb-10">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-slate-500 mt-1">
            Buat profil lembaga sebelum menambahkan anggota pengurusnya.
          </p>
        </div>
      </div>
      ...
      <Card className="shadow-sm border-slate-200">
        <CardHeader className="bg-slate-50/50 border-b">
          ...
          <CardDescription>
            Isi detail lembaga yang ada di desa.
          </CardDescription>
        </CardHeader>
                ...
                <div className="space-y-2">
                  ...
                  <div className="p-1 border rounded-lg bg-slate-50">
                    <ImageUpload
                      ...
                      onChange={(url, key) =>
                        setFormData({ ...formData, logoUrl: url, logoKey: key })
                      }
                      className="aspect-square w-full max-w-xs mx-auto object-contain bg-white"
                    />
                  </div>
                  <p className="text-xs text-slate-500 text-center mt-2">
                    Gunakan gambar persegi (1:1) berformat PNG dengan latar
                    transparan jika ada.
                  </p>
                </div>
              </div>
