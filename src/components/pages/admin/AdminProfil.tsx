...
export default function AdminProfil() {
  ...
  const [originalBaganKey, setOriginalBaganKey] = useState<string | undefined>(
    undefined,
  )
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-slate-500 text-sm mt-1">
            Kelola Visi, Misi, Sejarah, dan Struktur Organisasi Desa.
          </p>
        </div>
        <Button
          type="button"
        ...
        <div className="space-y-6">
          <Card className="overflow-hidden">
            <CardHeader className="bg-slate-50 border-b pb-4">
              <div className="text-lg font-bold text-slate-800">Visi Desa</div>
            </CardHeader>
          ...
          <Card className="overflow-hidden">
            <CardHeader className="bg-slate-50 border-b pb-4 flex flex-row items-center justify-between">
              <div className="text-lg font-bold text-slate-800">Misi Desa</div>
              <Button
                size="sm"
                variant="outline"
          ...
          <Card className="overflow-hidden">
            ...
            <CardContent className="pt-6 space-y-4">
              <p className="text-sm text-slate-500 mb-2">
                Unggah gambar diagram/bagan susunan organisasi pemerintahan
                desa. Rekomendasi rasio: 16:9 (Landscape) agar terlihat
                proporsional.
              </p>
              <ImageUpload
                value={baganUrl}
