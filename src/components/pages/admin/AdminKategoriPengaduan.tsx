...
export default function AdminKategoriPengaduan() {
  ...
  const [editingId, setEditingId] = useState<Id<'kategori_pengaduan'> | null>(
    null,
  )
  ...
  const [deleteId, setDeleteId] = useState<Id<'kategori_pengaduan'> | null>(
    null,
  )
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      toast.error(
        error.message ||
          'Gagal menghapus kategori. Mungkin kategori sedang digunakan.',
      )
    } finally {
      setDeleteId(null)
    }
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-slate-500 mt-1">
          Kelola daftar pilihan subjek/kategori laporan dari masyarakat.
        </p>
      </div>
        ...
        <div className="md:col-span-2">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Semua kategori yang tersedia di form kontak
              </CardDescription>
            </CardHeader>
            <CardContent>
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Apakah Anda yakin ingin menghapus kategori ini? Aksi ini tidak
              dapat dibatalkan. Kategori tidak bisa dihapus jika sudah ada
