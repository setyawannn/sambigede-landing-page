  ...
  if (berita === null) {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-[#F5F5F5] px-6 text-center">
        <h1 className="text-4xl font-bold text-[#333] mb-4">Berita Tidak Ditemukan</h1>
        <p className="text-[#666] mb-8">Maaf, berita yang Anda cari tidak tersedia atau telah dihapus.</p>
        <Link 
          to="/berita" 
